  ...
  return (
    <div className="bg-white border border-slate-100 sm:border-transparent sm:shadow-sm overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        <div className="h-9 w-9 rounded-full bg-gradient-to-br from-red-500 to-rose-600 flex items-center justify-center shrink-0">
        ...
        <button
          ...
          className={`text-left text-sm font-medium transition-colors w-full ${
            isLoggedIn
